...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    const checkLogin = async () => {
      const res = await fetch(`${config.apiUrl}/profile`, { credentials: "include" });
      if (res.ok) {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const check = await fetch(`${config.apiUrl}/users/profile`, { credentials: "include" });
  ...
  const handleRegister = async () => {
    ...
    try {
      const check = await fetch(`${config.apiUrl}/users`);
